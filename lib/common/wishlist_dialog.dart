...
class WishlistAlert extends StatefulWidget {
  final String? userId;
  ...
  @override
  _WishlistAlertState createState() => _WishlistAlertState();
}

class _WishlistAlertState extends State<WishlistAlert> {
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      onFieldSubmitted: (value) async {
                                        ...
                                        return createWishlist(value);
                                      },
                                    ),
                                  ),
                                  // loading == true && isEditing == false
                                  //     ? IconButton(
                                  //         onPressed: () {
                                  //           // Create wishlist
                                  //           if (controller.text.isEmpty) {
                                  //           } else
                                  //             createWishlist(controller.text);
                                  //         },
                                  //         icon: Icon(Icons.done),
                                  //       )
                                  //     : SizedBox.shrink()
